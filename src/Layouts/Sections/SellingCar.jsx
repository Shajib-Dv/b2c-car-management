        ...
        <div className='py-20'>
            <div className='flex justify-center items-center gap-16'>
                <div className='flex flex-col gap-5 items-start'>
                    ...
                    <p>
                        Book an appointment for free car inspection and <br /> sell it instantly on the same day.
                    </p>
                    <button className='border border-[#00A541] px-5 py-1 font-medium rounded-md'>SELL MY CAR</button>
                </div>
                <div>
                    <img src="https://cdn.discordapp.com/attachments/1094651413235253289/1144547473738711080/image_29.png" alt="" />
                </div>
            </div>
