        ...
        { images  && images?.map((img, index) => {
          return (
            <Accordion
              key={index}
              open={index === open}
              title={accordionData[index].title ? accordionData[index].title : carName + ' ' + 'Reviews'}
              des={accordionData[index].des}
              des1={accordionData[index].des1}
              img={img}
              toggle={() => toggle(index)}
            />
          );
