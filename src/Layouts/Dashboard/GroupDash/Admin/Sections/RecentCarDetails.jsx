...
const RecentCarDetails = () => {
  ...
  return (
    ...
    //     <h2 className="title">
    //       Details For
    //       <span className="text-green-600"> {basicInfo?.carName || "unknown"}</span>
    //     </h2>
    //   </div>
    ...
    //         ))
    //       ) : (
    //         <h2 className="text-red-500">No basic information found !</h2>
    //       )}
    //     </div>
    //   </div>
    ...
    //         ))
    //       ) : (
    //         <h2 className="text-red-500">No key specification found !</h2>
    //       )}
    //     </div>
    //   </div>
