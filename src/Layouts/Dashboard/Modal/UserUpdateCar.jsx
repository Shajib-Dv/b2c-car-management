...
const UserUpdateCar = ({ car, modal, refetch, close }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        fetch(`https://b2c-car-management-server-p6jwvedmy-shajib-dv.vercel.app/update_sell_car/${_id}`, {
            method: 'PUT',
            headers: {
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <div className="md:flex md:flex-row flex flex-col gap-5 mt-3 md:mb-1">
                                                    <CustomInput
