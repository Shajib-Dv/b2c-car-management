  ...
  return (
    <div className="shadow-inner bg-[#FAFAFA] lg:px-20 lg:py-10 p-5">
      ...
      <div className="lg:flex lg:mt-40 lg:gap-10 justify-between h-10 visibility: hidden lg:visibility: visible">
        <img
          className=""
          src="https://media.discordapp.net/attachments/1094651413235253289/1143862788163371149/image_10.png"
          alt=""
        />
        <img
          className=""
          src="https://media.discordapp.net/attachments/1094651413235253289/1143862787261612084/image_7.png"
          alt=""
        />
        <img
          className=""
          src="https://media.discordapp.net/attachments/1094651413235253289/1143862787743948870/image_8.png"
          alt=""
        />
        <img
          className=""
          src="https://media.discordapp.net/attachments/1094651413235253289/1143862788566032445/image_11.png"
          alt=""
        />
        <img
          className=""
          src="https://media.discordapp.net/attachments/1094651413235253289/1143862788922540062/image_12.png"
          alt=""
        />
      </div>
      <div className="mt-3">
        ...
        <div className="flex justify-between">
          <div>
            <img
              src="https://media.discordapp.net/attachments/1094651413235253289/1143862786888302733/Group_20025.png"
              alt=""
            />
